...
export type Database = {
  ...
  public: {
    Tables: {
      job_offers: {
        Row: {
          ...
          offer_in_kind_description: string | null
          offer_payment_type: Database["public"]["Enums"]["payment_type"]
    ...
    Enums: {
      ...
      user_role: "member" | "makerspace_member"
    }
    CompositeTypes: {
      [_ in never]: never
    }
